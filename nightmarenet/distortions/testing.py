...
from nightmarenet.distortions.validators import validate_base_distortion, validate_distortion_contract
...
def validate_distortion_function(fn) -> List[str]:
    ...
    Args:
        fn: A distortion function with signature (text: str, strength: float, seed: int = None) -> str
